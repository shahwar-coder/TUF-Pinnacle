...
# Step 1: gcd(8, 9)
# Since n1 < n2, no issue — we just follow the rule:
# gcd(8, 9) = gcd(9, 8 % 9)

# Step 2: 8 % 9 = 8
# So → gcd(9, 8)

# Step 3: gcd(9, 8) = gcd(8, 9 % 8)
# 9 % 8 = 1
# So → gcd(8, 1)

# Step 4: gcd(8, 1) = gcd(1, 8 % 1)
# 8 % 1 = 0
# So → gcd(1, 0)

# ✅ When the second value becomes 0, the first value (1) is the GCD.
# → GCD = 1
